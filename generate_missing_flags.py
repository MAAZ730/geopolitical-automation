...
def generate_missing_flags() -> None:
    """Create fallback flags so card generation keeps working offline."""
    ...
    # NATO doesn't have a standard flag — we render a neutral dark-blue fallback.
